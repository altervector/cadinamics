document.addEventListener("DOMContentLoaded", () => {
    const enllacosHTML = `
        ...
        <div class="bloc-enllacos">
            ...
            <p><a href="https://www.instagram.com/carlescadi" target="_blank"><img src="https://altervector.github.io/cadinamics/Icon/Icoinsta.png" alt="Instagram" class="icona-app">Instagram: @cadicarles</a></p>
